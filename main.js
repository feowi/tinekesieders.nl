...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		if (!App)
		{
			...
			Game.attachTooltip(l('topbarSteamCC'),'<div style="padding:8px;width:250px;text-align:center;">Hier is de website gemaakt, 12 cent voor een jaar.</div>','this');
			Game.attachTooltip(l('topbarRandomgen'),'<div style="padding:8px;width:250px;text-align:center;">Facebook van MILF</div>','this');
			Game.attachTooltip(l('topbarIGM'),'<div style="padding:8px;width:250px;text-align:center;">Linkedin van patat man</div>','this');
