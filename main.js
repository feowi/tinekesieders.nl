...
var Langs={
	...
	'NL':{file:'NL',nameEN:'Dutch',name:'Kies deze taal voor de accurate namen.',changeLanguage:'Taal',icon:0,w:1},
...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.DefaultPrefs=function()
		{
			...
			Game.prefs.notifs=1;//notifications fade faster
			...
			Game.prefs.customGrandmas=0;//if true, show patreon names for grandmas
